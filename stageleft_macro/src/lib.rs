...
pub fn entry(
    ...
    proc_macro::TokenStream::from(quote_spanned! {input.span()=>
        ...
        #orig_visibility fn #input_name(input: #root::internal::TokenStream) -> #root::internal::TokenStream {
            ...
            let mut module_path = module_path.segments.iter().skip(1).cloned().collect::<Vec<_>>();
            module_path.insert(0, #root::internal::syn::PathSegment {
                ident: #root::internal::syn::Ident::new("__flow", #root::internal::proc_macro2::Span::call_site()),
                arguments: #root::internal::syn::PathArguments::None,
            });
