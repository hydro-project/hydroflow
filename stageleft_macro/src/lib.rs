...
pub fn q(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    proc_macro::TokenStream::from(quote!({
        ...
        move |set_mod: &mut String, set_crate_name: &mut &'static str, set_tokens: &mut #root::internal::TokenStream, set_vec: &mut Vec<(String, (Option<#root::internal::TokenStream>, Option<#root::internal::TokenStream>))>, run: bool| {
