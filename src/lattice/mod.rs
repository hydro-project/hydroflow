...
pub trait Merge<Delta: LatticeRepr>: LatticeRepr<Lattice = Delta::Lattice> {
    ...
    fn merge_hide<'h, 'g, Y: Qualifier, Z: Qualifier>(this: &mut Hide<'h, Y, Self>, delta: Hide<'g, Z, Delta>) -> bool {
...
pub trait Convert<Target: LatticeRepr<Lattice = Self::Lattice>>: LatticeRepr {
    ...
    fn convert_hide<'h, Y: Qualifier>(this: Hide<'h, Y, Self>) -> Hide<'h, Y, Target> {
