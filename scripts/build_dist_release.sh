...
CARGO_NET_GIT_FETCH_WITH_CLI="true" cargo build --release --all-targets --workspace --exclude hydro_deploy hydro_cli hydroflow_plus_cli_integration hydroflow_plus_test --target ${RUST_TARGET}
