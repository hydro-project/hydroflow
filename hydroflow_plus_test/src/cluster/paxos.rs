...
pub fn paxos_core<'a, P: PaxosPayload, R>(
    ...
    let (p_to_proposers_i_am_leader_complete_cycle, p_to_proposers_i_am_leader) =
        proposers.cycle::<Stream<_, _, _, _>>();
...
fn acceptor<'a, P: PaxosPayload, R>(
    ...
    r_to_acceptors_checkpoint: Stream<(ClusterId<R>, i32), Unbounded, NoTick, Cluster<'a, Acceptor>>,
    ...
    let a_new_checkpoint = a_checkpoint_largest_seqs
        ...
        .map(q!(|min_seq| (
            ...
            P2a {
                ...
                ballot: Ballot { num: 0, id: ClusterId::from_raw(0) },
                slot: -1,
    ...
    let a_max_ballot = p_to_acceptors_p1a
        ...
        .max()
        .unwrap_or(acceptors.singleton(q!(Ballot { num: 0, id: ClusterId::from_raw(0) })));
...
fn p_p2b<'a, P: PaxosPayload>(
    proposers: &Cluster<'a, Proposer>,
    a_to_proposers_p2b: Stream<(ClusterId<Acceptor>, P2b<P>), Unbounded, NoTick, Cluster<'a, Proposer>>,
    f: usize,
) -> Stream<(i32, P), Unbounded, NoTick, Cluster<'a, Proposer>> {
    ...
    let p_count_matching_p2bs = p_p2b
        ...
        .fold_keyed(
            q!(|| (
                ...
                P2b {
                    ballot: Ballot { num: 0, id: ClusterId::from_raw(0) },
                    max_ballot: Ballot { num: 0, id: ClusterId::from_raw(0) },
                    slot: 0,
                    value: Default::default()
                }
            )),
...
fn p_p1b<'a, P: PaxosPayload>(
    proposers: &Cluster<'a, Proposer>,
    a_to_proposers_p1b: Stream<(ClusterId<Acceptor>, P1b<P>), Unbounded, NoTick, Cluster<'a, Proposer>>,
    p_ballot_num: Singleton<u32, Bounded, Tick, Cluster<'a, Proposer>>,
...
fn p_max_ballot<'a, P: PaxosPayload>(
    ...
    p_received_p1b_ballots
        ...
        .max()
        .unwrap_or(proposers.singleton(q!(Ballot { num: 0, id: ClusterId::from_raw(0) })))
}
