...
class Deployment(object):
    ...
    def ExistingGCPComputeEngineHost(self, project: str, name: str, zone: Optional[str] = None, user: Optional[str] = None, existing_private_key_path: Optional[str] = None) -> "GCPComputeEngineHost": ...
