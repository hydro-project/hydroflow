...
mod fns {
    ...
    impl<Y: Qualifier, K: Clone, InnerK: Clone, Tag, InnerTag, InnermostLr>
        Hide<Y, MapUnionRepr<Tag, K, MapUnionRepr<InnerTag, InnerK, InnermostLr>>>
    where
        InnermostLr: LatticeRepr,
        InnerTag: MapTag<InnerK, InnermostLr::Repr>,
        MapUnionRepr<InnerTag, InnerK, InnermostLr>: LatticeRepr,
        <MapUnionRepr<InnerTag, InnerK, InnermostLr> as LatticeRepr>::Repr:
            IntoIterator<Item = (InnerK, InnermostLr::Repr)>,
        ...
        <MapUnionRepr<Tag, K, MapUnionRepr<InnerTag, InnerK, InnermostLr>> as LatticeRepr>::Repr:
            IntoIterator<
                Item = (
                    K,
                    <MapUnionRepr<InnerTag, InnerK, InnermostLr> as LatticeRepr>::Repr,
            ...
            >,
    {
        ...
        {
            let mut out = <<MapUnionRepr<
                TargetTag,
                InnerK,
                MapUnionRepr<TargetInnerTag, K, InnermostLr>,
            > as LatticeRepr>::Repr as Default>::default();
    ...
    where
        ...
        <MapUnionRepr<Tag, K, InnerLr> as LatticeRepr>::Repr:
            IntoIterator<Item = (K, InnerLr::Repr)>,
    {
    ...
    where
        ...
        <MapUnionRepr<Tag, K, SetUnionLr> as LatticeRepr>::Repr:
            IntoIterator<Item = (K, SetUnionLr::Repr)>,
    {
        ...
        {
            let mut out =
                <<SetUnionRepr<TargetTag, (K, V)> as LatticeRepr>::Repr as Default>::default();
