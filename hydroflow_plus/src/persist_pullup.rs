...
fn persist_pullup_node<'a>(
    ...
    if let HfPlusNode::Unpersist(box HfPlusNode::Persist(_)) = node {
    ...
    } else if let HfPlusNode::CrossProduct(
        box HfPlusNode::Persist(_),
        box HfPlusNode::Persist(_),
    ) = node
    {
        ...
        {
            *node = HfPlusNode::Persist(Box::new(HfPlusNode::Delta(Box::new(HfPlusNode::CrossProduct(
    ...
    } else if let HfPlusNode::Join(
        box HfPlusNode::Persist(_),
        box HfPlusNode::Persist(_),
    ) = node
    {
        if let HfPlusNode::Join(
            box HfPlusNode::Persist(left),
            box HfPlusNode::Persist(right),
        ) = std::mem::replace(node, HfPlusNode::Placeholder)
        {
            *node = HfPlusNode::Persist(Box::new(HfPlusNode::Delta(Box::new(HfPlusNode::Join(
                Box::new(HfPlusNode::Persist(left)),
                Box::new(HfPlusNode::Persist(right)),
            )))));
        } else {
