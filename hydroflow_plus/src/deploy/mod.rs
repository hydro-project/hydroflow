...
pub trait LocalDeploy<'a> {
    ...
    fn default_process(_id: usize) -> Self::Process {
        panic!("No default process")
    }

    fn default_cluster(_id: usize) -> Self::Cluster {
        panic!("No default cluster")
    }
}
    ...
    > LocalDeploy<'a> for T
{
    ...
    fn has_default_node() -> bool {
        <T as Deploy<'a>>::has_default_node()
    }

    fn default_process(id: usize) -> Self::Process {
        <T as Deploy<'a>>::default_process(id)
    }

    fn default_cluster(id: usize) -> Self::Cluster {
        <T as Deploy<'a>>::default_cluster(id)
    }
}
