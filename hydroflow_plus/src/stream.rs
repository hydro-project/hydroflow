...
use crate::node::{HfConnectable, HfDeploy, HfNode};
use crate::HfBuilder;

pub struct HfStream<'a, T, D: HfDeploy<'a>, N: HfNode<'a>> {
...
impl<'a, T, D: HfDeploy<'a>, N: HfNode<'a>> HfStream<'a, T, D, N> {
...
impl<'a, D: HfDeploy<'a>, N: HfNode<'a>> HfStream<'a, Bytes, D, N> {
...
impl<'a, K, V1, D: HfDeploy<'a>, N: HfNode<'a>> HfStream<'a, (K, V1), D, N> {
