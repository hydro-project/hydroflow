...
pub fn identity_write_iterator_fn(write_iterator_args: &WriteIteratorArgs) -> TokenStream {
...
pub const IDENTITY_WRITE_FN: &'static dyn Fn(
    &WriteContextArgs<'_>,
    &WriteIteratorArgs<'_>,
) -> OperatorWriteOutput = &(|_write_context_args, write_iterator_args| {
    let write_iterator = identity_write_iterator_fn(write_iterator_args);
    OperatorWriteOutput {
        write_iterator,
        ..Default::default()
    }
...
pub const OPERATORS: [OperatorConstraints; 21] = [
    OperatorConstraints {
        ...
        write_fn: &(|&WriteContextArgs { root, .. },
                     &WriteIteratorArgs {
                         ident,
                         inputs,
                         outputs,
