...
pub const JOIN_HACK: OperatorConstraints = OperatorConstraints {
    name: "join_hack",
    hard_range_inn: &(2..=2),
    soft_range_inn: &(2..=2),
    ...
    write_fn: &(|wc @ &WriteContextArgs {
                        ...
                        quote_spanned! {op_span=>
                            #root::lang::monotonic_map::MonotonicMap::new_init(
                                #root::lang::clear::ClearDefault(
                                    #root::compiled::pull::HalfJoinStateHack::default()
                                )
                            )
                        },
                        quote_spanned! {op_span=>
        ...
        let write_iterator = quote_spanned! {op_span=>
            ...
            let #ident = {
                ...
                {
                    #root::compiled::pull::SymmetricHashJoinHack::new_from_mut(lhs, rhs, lhs_state, rhs_state)
                }
