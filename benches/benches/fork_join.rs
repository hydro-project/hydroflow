    ...
    c.bench_function("fork_join/hydroflow/surface", |b| {
        b.iter(|| {
            let mut hf = hydroflow_syntax! {
                ...
                a1 = union() -> tee();
                a1 -> filter(|x| x % 2 == 0) -> a2;
                a1 -> filter(|x| x % 2 == 1) -> a2;
                a2 = union() -> tee();
                a2 -> filter(|x| x % 2 == 0) -> a3;
                a2 -> filter(|x| x % 2 == 1) -> a3;
                a3 = union() -> tee();
                a3 -> filter(|x| x % 2 == 0) -> a4;
                a3 -> filter(|x| x % 2 == 1) -> a4;
                a4 = union() -> tee();
                a4 -> filter(|x| x % 2 == 0) -> a5;
                a4 -> filter(|x| x % 2 == 1) -> a5;
                a5 = union() -> tee();
                a5 -> filter(|x| x % 2 == 0) -> a6;
                a5 -> filter(|x| x % 2 == 1) -> a6;
                a6 = union() -> tee();
                a6 -> filter(|x| x % 2 == 0) -> a7;
                a6 -> filter(|x| x % 2 == 1) -> a7;
                a7 = union() -> tee();
                a7 -> filter(|x| x % 2 == 0) -> a8;
                a7 -> filter(|x| x % 2 == 1) -> a8;
                a8 = union() -> tee();
                a8 -> filter(|x| x % 2 == 0) -> a9;
                a8 -> filter(|x| x % 2 == 1) -> a9;
                a9 = union() -> tee();
                a9 -> filter(|x| x % 2 == 0) -> a10;
                a9 -> filter(|x| x % 2 == 1) -> a10;
                a10 = union() -> tee();
                a10 -> filter(|x| x % 2 == 0) -> a11;
                a10 -> filter(|x| x % 2 == 1) -> a11;
                a11 = union() -> tee();
                a11 -> filter(|x| x % 2 == 0) -> a12;
                a11 -> filter(|x| x % 2 == 1) -> a12;
                a12 = union() -> tee();
                a12 -> filter(|x| x % 2 == 0) -> a13;
                a12 -> filter(|x| x % 2 == 1) -> a13;
                a13 = union() -> tee();
                a13 -> filter(|x| x % 2 == 0) -> a14;
                a13 -> filter(|x| x % 2 == 1) -> a14;
                a14 = union() -> tee();
                a14 -> filter(|x| x % 2 == 0) -> a15;
                a14 -> filter(|x| x % 2 == 1) -> a15;
                a15 = union() -> tee();
                a15 -> filter(|x| x % 2 == 0) -> a16;
                a15 -> filter(|x| x % 2 == 1) -> a16;
                a16 = union() -> tee();
                a16 -> filter(|x| x % 2 == 0) -> a17;
                a16 -> filter(|x| x % 2 == 1) -> a17;
                a17 = union() -> tee();
                a17 -> filter(|x| x % 2 == 0) -> a18;
                a17 -> filter(|x| x % 2 == 1) -> a18;
                a18 = union() -> tee();
                a18 -> filter(|x| x % 2 == 0) -> a19;
                a18 -> filter(|x| x % 2 == 1) -> a19;
                a19 = union() -> tee();
                a19 -> filter(|x| x % 2 == 0) -> a20;
                a19 -> filter(|x| x % 2 == 1) -> a20;
