...
source_iter(0..10)
  ...
  "Chat Server": `\
// https://github.com/hydro-project/hydroflow/blob/main/template/dfir/src/server.rs
...
inbound_chan[msgs] -> [0]broadcast;
  ...
  "Chat Client": `\
// https://github.com/hydro-project/hydroflow/blob/main/template/dfir/src/client.rs
// set up channels
outbound_chan = union() -> dest_sink_serde(outbound);
