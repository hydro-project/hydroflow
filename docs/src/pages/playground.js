...
import { init, compile_hydroflow, compile_datalog, __wbg_set_wasm } from "hydroflow-demo";
import * as wasm from "hydroflow-demo/hydroflow_demo_bg.wasm";

import mermaid from "mermaid";

import styles from "./playground.module.css";

// TODO(shadaj): figure out why this hack is necessary
// console.log(wasm);
// __wbg_set_wasm(wasm);
init();
